...
class ZeebeClient(object):
    ...
    async def run_process(self, bpmn_process_id: str, variables: Optional[Dict] = None, version: int = -1) -> ProcessInstance:
        """
        Run process
        ...
        Returns:
            ProcessInstance: Dataclass containing info about the running process generated by Zeebe.
    ...
    async def run_process_with_result(
        ...
        Returns:
            tuple: (Dataclass describing the process instance, A dictionary of the end state of the process instance)
